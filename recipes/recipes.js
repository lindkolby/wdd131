...
function buildStars(rating) {
    ...
    return `
      <article class="recipe-card">
        ...
        <div class="recipe-info">
          ...
          <span class="rating">${buildStars(recipe.rating)}</span>
  ...
  function filterRecipes(query) {
    ...
    return recipes.filter(recipe => {
      return (
        ...
        recipe.tags.join(" ").toLowerCase().includes(q)
      );
    });
  }
  ...
  document.querySelector("#searchBtn").addEventListener("click", searchAndDisplay);
